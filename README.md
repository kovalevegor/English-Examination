...
// актуальность работы
// цель
// список задач по реализации программы, которые нужно выполнить для достижения цели (как эти задачи решались нужно будет расписать в разделе 3)


Давайте сначала о главном в форме легкого ликбеза, а именно: куда вы вообще собрались, что такое игровая индустрия сегодня, что в ней происходит, какая флора и фауна ее населяет и каковы настоящие реалии этого причудливого, прекрасного, хотя порой и жестокого мира. Я обойдусь без исторического экскурса. Прочитать про то, как Аллан Элкорн придумал Pong и что было после этого, вы сможете где-нибуд
